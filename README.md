...
- Lassie streams output by default and supports on-the-fly extraction of the original files
...
_Note: For the internet cautious out there, the `bafybeic56z3yccnla3cutmvqsn5zy3g24muupcsjtoyp3pu5pm5amurjx4` CID is a directory containing a short video file. You may use it to test Lassie._
