...
The Sheltie HTTP specification is an HTTP interface for retrieving IPLD data from IPFS and Filecoin peers. It fetches content over the HTTP protocol and provides the resulting data in CAR format.
