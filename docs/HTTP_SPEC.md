...
The Lassie HTTP specification is an HTTP interface for retrieving IPLD data from IPFS and Filecoin peers. It fetches content over the GraphSync and HTTP protocols and provides the resulting data in CAR format.
